...
import com.gymxy.gymxyone.presentation.composableFunctions.PerformedDaysList
...
fun HomeScreen(
    ...
    val orientation = LocalConfiguration.current.orientation == android.content.res.Configuration.ORIENTATION_PORTRAIT
    Box(
        modifier = Modifier
            .fillMaxSize()
    ...
    Box(modifier = Modifier.safeDrawingPadding()) {
        ...
        Column(
            ...
            Row(  // for the title and setting icon
                ...
                NormalText(
                    text = "Good Afternoon Rohan",
                    textSize = 24
                )  // homeViewModel.getGreetings()
                Spacer(modifier = Modifier.size(10.dp))
                Image(
            ...
            Row(
                ...
                val options = listOf("Small", "Medium", "Large")  // TODO add the list here
